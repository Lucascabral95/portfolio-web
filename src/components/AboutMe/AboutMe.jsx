...
const EMAIL = "Lucassimple@hotmail.com";
...
const STATS = [
  ...
  { value: "80%+", label: "Cobertura de testing" },
];
      ...
      <div className="aboutMe__container">
        <animated.div style={containerSpring} className="aboutMe__content">
          <div className="aboutMe__text">
            <span
              className="aboutMe__availability"
            ...
            <h2 className="aboutMe__subtitle" style={{ minHeight: MIN_HEIGHT }}>
            ...
            <p className="aboutMe__description" style={{ marginBottom: "0px" }}>
              Soy Desarrollador Full Stack especializado en arquitecturas
              event-driven y microservicios con TypeScript, NestJS y Go.
              Despliego infraestructura en AWS (Lambda, ECS Fargate, SQS) con
              Terraform y pipelines CI/CD.
            </p>
            <p className="aboutMe__description" style={{ marginTop: "-12px" }}>
              En el frontend construyo interfaces con React, Next.js y Angular,
              aplicando SSR, autenticación robusta (Cognito, OAuth2, JWT) e
              integración de pagos con Stripe y Mercado Pago. Software escalable
              y testeado con +80% de cobertura.
            </p>

            <ul
              className="aboutMe__badges"
          ...
          <animated.div style={photoSpring} className="aboutMe__photo">
            <div
              className={`photo__ring ${imageLoaded ? "is-loaded" : ""}`}
              aria-hidden="true"
            />
            {!imageLoaded && (
              <div className="photo__skeleton" aria-hidden="true" />
            )}
            <img
